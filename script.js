...
const SOLUTIONS = [
  ...
  { id: 'attackSurfaceManagement', label: 'Attack Surface Management' },
  ...
  { id: 'managedEdr', label: '(Mngd) EDR' },
  { id: 'emailSecurity', label: 'Email Security' },
  { id: 'firewall', label: 'Firewall' },
  { id: 'managedFirewall', label: '(Mngd) Firewall' },
  { id: 'managedGrc', label: '(Mngd) GRC' },
  { id: 'iam', label: 'IAM' },
  { id: 'impersonation', label: 'Impersonation' },
  { id: 'incidentResponse', label: 'Incident Response' },
  { id: 'mfaSso', label: 'MFA / SSO' },
  { id: 'managedPatching', label: '(Mngd) Patching' },
  { id: 'microsegmentation', label: 'Microsegmentation' },
  { id: 'managedControlsAssurance', label: '(Mngd) Controls Assurance' },
  ...
  { id: 'managedSiem', label: '(Mngd) SIEM' },
  { id: 'soc', label: 'SOC' },
  { id: 'sse', label: 'SSE' },
